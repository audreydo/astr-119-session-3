...
print(type(a_i[0]))				#will return int64, meaning the data type is a 64-bit integer

#floats

x = 119.0			#floating point number
print(type(x))		#print out the data type of x, which is float

y = 1.19e2			#float 119 in scientific notation
print(type(y))		#print out the data type of y

z = np.zeros(i, dtype=float)		#declare array of floats, which is ten 0's
